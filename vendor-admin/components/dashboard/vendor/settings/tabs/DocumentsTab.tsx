...
export default function DocumentsTab({ docsData, onFileUpload, isUploading }: DocumentsTabProps) {
  ...
  const docItems = [
    ...
    { id: "businessLicense", title: "Business License", status: "Verified", date: "2024-01-15", url: docsData?.data?.businessLicense },
    { id: "vendorPhotos", title: "Vendor Photos", status: "Verified", date: "2024-01-15", url: docsData?.data?.vendorPhotos },
