...
class AppBootstrap extends StatelessWidget {
  ...
  static Future<void> initialize({
    ...
    // Initialize Remote Config for feature flags and app configuration
    // Use a temporary ProviderContainer for initialization
    final initContainer = ProviderContainer();
    try {
      final remoteConfig = initContainer.read(
        firebaseRemoteConfigServiceProvider,
      );

      // Configure and fetch initial values
      // In debug: fetch immediately, in production: respect cache interval
      ...
      AppLogger.instance.i('Remote Config initialized and fetched');
    } catch (e, stack) {
    ...
    // Analytics and Performance services are lazily initialized
