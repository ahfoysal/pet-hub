...
mixin _$User {
 ...
 String get id; String get email;@JsonKey(name: 'fullName', defaultValue: null) String? get name;@JsonKey(name: 'image') String? get avatarUrl;@JsonKey(name: 'isEmailVerified') bool get isEmailVerified;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(fromJson: _roleFromJson, toJson: _roleToJson) UserRole get role;
...
@useResult
$Res call({
 String id, String email,@JsonKey(name: 'fullName', defaultValue: null) String? name,@JsonKey(name: 'image') String? avatarUrl,@JsonKey(name: 'isEmailVerified') bool isEmailVerified,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(fromJson: _roleFromJson, toJson: _roleToJson) UserRole role
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email, @JsonKey(name: 'fullName', defaultValue: null)  String? name, @JsonKey(name: 'image')  String? avatarUrl, @JsonKey(name: 'isEmailVerified')  bool isEmailVerified, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(fromJson: _roleFromJson, toJson: _roleToJson)  UserRole role)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email, @JsonKey(name: 'fullName', defaultValue: null)  String? name, @JsonKey(name: 'image')  String? avatarUrl, @JsonKey(name: 'isEmailVerified')  bool isEmailVerified, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(fromJson: _roleFromJson, toJson: _roleToJson)  UserRole role)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.email,_that.name,_that.avatarUrl,_that.isEmailVerified,_that.createdAt,_that.role);case _:
  return null;
...
class _User implements User {
  const _User({required this.id, required this.email, @JsonKey(name: 'fullName', defaultValue: null) this.name, @JsonKey(name: 'image') this.avatarUrl, @JsonKey(name: 'isEmailVerified') this.isEmailVerified = false, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(fromJson: _roleFromJson, toJson: _roleToJson) this.role = UserRole.petOwner});
  factory _User.fromJson(Map<String, dynamic> json) => _$UserFromJson(json);

@override final  String id;
@override final  String email;
@override@JsonKey(name: 'fullName', defaultValue: null) final  String? name;
