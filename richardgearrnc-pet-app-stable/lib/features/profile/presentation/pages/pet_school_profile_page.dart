...
/// Profile page for pet schools.
///
/// Features:
/// - View pet school profile and classes
  ...
  Widget build(final BuildContext context, final WidgetRef ref) {
    ...
    useOnMount(() {
      ref
          ...
          .logScreenView(
            screenName: 'profile_school',
          );
    });

    return Scaffold(
      appBar: AppBar(
        title: Text('${l10n.profile} - Pet School'),
        actions: [
          AppIconButton(
                ...
                child: Column(
                  children: [
                    ListTile(
                      ...
                      trailing: Icon(Icons.arrow_forward_ios, size: 16),
                      onTap: () => context.goRoute(AppRoute.bookingsSchool),
                    ),
                    Divider(height: 1),
                    ListTile(
                      leading: Icon(
