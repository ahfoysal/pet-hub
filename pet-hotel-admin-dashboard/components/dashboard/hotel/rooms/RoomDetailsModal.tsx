...
import { useGetRoomByIdQuery } from "@/redux/features/api/dashboard/hotel/room/hotelRoomApi";
...
export default function RoomDetailsModal({
  ...
  const formatRoomType = (type: string) => {
    switch (type) {
      case "PET_ONLY": return "Pet Only";
      case "PET_WITH_ACCO": return "Pet with Accommodation";
      default: return type;
    }
  };
