...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      <div
        onClick={handleClick}
        className={`cursor-pointer border border-border rounded-xl p-6 flex flex-col items-center justify-center hover:border-gray-400 transition bg-[#F9FAFB] ${className || ""}`}
      >
