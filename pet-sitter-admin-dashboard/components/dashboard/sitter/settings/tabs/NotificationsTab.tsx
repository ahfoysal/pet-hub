...
export default function NotificationsTab({ formData, onChange, onToggle, onSave, isUpdating }: NotificationsTabProps) {
  const items = [
    { id: "newBookings", label: "New Bookings", desc: "Get notified when you receive a new booking" },
    { id: "checkInReminders", label: "Check-in Reminders", desc: "Receive alerts for upcoming check-ins" },
    { id: "checkOutReminders", label: "Check-out Reminders", desc: "Receive alerts for upcoming check-outs" },
    // ...
  ];
  ...
  const notificationItems = [
    ...
    { id: "bookingCancellations", label: "Booking Cancellations", desc: "Get notified when bookings are cancelled" },
  ];
