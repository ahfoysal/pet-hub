          ...
          {session?.user?.role ? (
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8 sm:mb-16 animate-fade-in-buttons">
              <Button
                text="Log in"
                variant="outline"
                href={`${process.env.NEXT_PUBLIC_AUTH_URL || "http://auth.lvh.me:3000"}/?callbackUrl=${encodeURIComponent(typeof window !== "undefined" ? window.location.href : "")}`}
                className="px-14"
              />

              <Button
                text="Get Started"
                href={`${process.env.NEXT_PUBLIC_AUTH_URL || "http://auth.lvh.me:3000"}/register?callbackUrl=${encodeURIComponent(typeof window !== "undefined" ? window.location.href : "")}`}
