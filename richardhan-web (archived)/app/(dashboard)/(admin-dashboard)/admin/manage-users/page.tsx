...
const ROLE_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
  ...
  PET_SITTER: { label: "Pet Sitter", color: "text-violet-700", bg: "bg-violet-50" },
  PET_HOTEL: { label: "Pet Hotel", color: "text-teal-700", bg: "bg-teal-50" },
  PET_SCHOOL: { label: "Pet School", color: "text-orange-700", bg: "bg-orange-50" },
...
export default function AdminManageUsersPage() {
  ...
  const getRoleConfig = (role: string) =>
    ROLE_CONFIG[role] || { label: role, color: "text-gray-700", bg: "bg-gray-50" };
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <span
                              className={`inline-flex items-center px-2 py-0.5 text-xs font-semibold rounded-full flex-shrink-0 ${role.bg} ${role.color}`}
                            >
                              {role.label}
                            </span>
                          </div>
              ...
              <div className="bg-amber-50 rounded-xl p-3.5">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs text-amber-800">
                    This user will be temporarily restricted from accessing
                    the platform for the selected duration.
                  </p>
                </div>
              </div>
            </div>
