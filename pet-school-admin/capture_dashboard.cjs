...
(async () => {
  ...
  await page.goto('http://localhost:3006/school', { waitUntil: 'networkidle0' });
  
  // Wait a moment for any client-side rendering
  await new Promise(r => setTimeout(r, 2000));
  
  const timestamp = Date.now();
  const path = `/Users/foysal/.gemini/antigravity/brain/7d3da660-2bd0-49b0-902b-5c2f08025d26/pet_school_dashboard_${timestamp}.png`;
